...
export const closePosition = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) => closeUserPosition(context?.userId || "admin", data.id, data.closePrice));

export const getPlatformSettings = createServerFn({ method: "GET" })
  .handler(async ({ context }) => adminGetPlatformSettings(context?.userId || "admin"));
